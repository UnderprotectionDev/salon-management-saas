...
> Nothing here is committed. Ideas only, contingent on MVP success and customer demand.

| Feature | Priority | Description |
|---------|----------|-------------|
| Customer Payment Processing | High | Deposits, prepayment, refunds via Polar.sh SDK |
| Multi-Location Support | Medium | Single org with multiple physical locations |
| Recurring Appointments | Medium | Weekly/bi-weekly/monthly auto-booking |
...
**Promotion criteria:** Multiple paying customers request it, clear ROI, technically feasible without rewrites.

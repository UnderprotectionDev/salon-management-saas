            ...
            <>
              ...
              <div className="p-1">
                <button
                  ...
                  className="hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-pointer items-center justify-center rounded-sm border-0 bg-transparent px-2 py-1.5 text-sm outline-hidden select-none"
                >
                  Clear filters
                </button>
              </div>

/**
 * Shared appointment status constants and helpers.
 */
...
export const PAST_STATUSES = ["completed", "cancelled", "no_show"] as const;
...
/** Check if an appointment can still be modified (cancelled/rescheduled) */
